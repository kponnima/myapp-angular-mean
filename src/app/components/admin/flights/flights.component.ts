...
export class FlightsComponent implements OnInit {
  ...
  @Input() flight: Flight;
  flights: any;
  displayedColumns = ['flight_no', 'origin', 'destination', 'departureDate', 'departureTime', 'arrivalDate', 'arrivalTime',
    'departureGate', 'arrivalGate', 'aircraft_no', 'cancelStatus', 'price', 'webCheckinTime', 'mealService'];
